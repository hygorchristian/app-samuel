...
public class TelaAberturaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLisataCidade.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent psaasCidade = new Intent(TelaAberturaActivity.this, MainActivity.class);
                psaasCidade.putExtra("nomeCidade", listaCidade.get(i).getNomeCidade());
                try {
                    startActivity(psaasCidade);
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public void carregarSpinerCidades() {
        ...
        if (!url.isEmpty()) {
            ...
            Toast.makeText(TelaAberturaActivity.this, "Não a dados para carregar no momento... !", Toast.LENGTH_LONG).show();
            finish();
        }
